...
// CreateAsset issues a new asset to the world state with given details - device ID is auto-generated by smart contract
...
// CreateAsset issues a new asset to the world state with given details - device ID provided by the admin user/client
func (s *SmartContract) CreateNewDeviceWithId(ctx contractapi.TransactionContextInterface, id string, owner string, name string, region string) (string, error) {
	exists, err := s.AssetExists(ctx, id)
	if err != nil {
		return "", err
	}
